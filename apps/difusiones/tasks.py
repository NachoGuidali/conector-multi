...
def send_difusion_task(self, difusion_id: int):
    ...
    from apps.whatsapp.sender import EvolutionClient

    try:
        difusion = Difusion.objects.select_related('numero').get(pk=difusion_id)
    ...
    try:
        ...
        client = EvolutionClient(difusion.numero)
        first = True
        ...
        for dc in pendientes:
            ...
            try:
                ...
                result = client.send_text_message(dc.telefono, mensaje)
