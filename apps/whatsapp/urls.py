...
urlpatterns = [
    # Webhook Evolution API — uno por instancia/número conectado
    path('webhook/<slug:instance_name>/', views.WebhookView.as_view(), name='webhook'),
    ...
    path('numeros/', views.NumeroListView.as_view(), name='numero_list'),
    path('numeros/nuevo/', views.NumeroCreateView.as_view(), name='numero_create'),
    path('numeros/<int:pk>/editar/', views.NumeroUpdateView.as_view(), name='numero_update'),
    path('numeros/<int:pk>/qr/', views.QRCodeView.as_view(), name='qr'),
    path('numeros/<int:pk>/estado/', views.ConnectionStatusView.as_view(), name='connection_status'),
    path('numeros/<int:pk>/logout/', views.LogoutInstanceView.as_view(), name='logout_instance'),
